...
if __name__ == '__main__':
    bank = nal()
    print(bank.start(mode='in', cash=80000))
    print(bank.start(mode='in', cash=1000))
    print(bank.start(mode='out', cash=1200))
    print(bank.start(mode='in', cash=18000))
    print(bank.start(mode='in', cash=10000))
    print(bank.start(mode='in', cash=25000))
    print(bank.start(mode='out', cash=50000))
